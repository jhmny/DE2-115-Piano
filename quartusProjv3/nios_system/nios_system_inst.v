	nios_system u0 (
		...
		.audio_and_video_config_SDAT (<connected-to-audio_and_video_config_SDAT>), // audio_and_video_config.SDAT
		.audio_and_video_config_SCLK (<connected-to-audio_and_video_config_SCLK>)  //                       .SCLK
	);

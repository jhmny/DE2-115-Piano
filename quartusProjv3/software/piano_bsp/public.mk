...
# setting SOPC_SYSID_BASE_ADDRESS is 0x8409130
SOPC_SYSID_FLAG += --sidp=0x8409130
ELF_PATCH_FLAG  += --sidp 0x8409130

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1607420416
SOPC_SYSID_FLAG += --timestamp=1607420416
ELF_PATCH_FLAG  += --timestamp 1607420416
